...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, error_grad_flag=True):
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, zero_grad_mea=True):
        ...
        self.linear = nn.Sequential(Linear(512 * block.expansion, num_classes))
